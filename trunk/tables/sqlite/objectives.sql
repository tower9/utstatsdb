CREATE TABLE %dbpre%objectives (
  obj_num INTEGER PRIMARY KEY,
  obj_map mediumint(8) NOT NULL default 0,
  obj_priority tinyint(4) NOT NULL default 0,
  obj_secondary tinyint(1) NOT NULL default 0,
  obj_desc varchar(121) NOT NULL default '',
  obj_times mediumint(8) NOT NULL default 0,
  obj_besttime int(10) NOT NULL default 0,
