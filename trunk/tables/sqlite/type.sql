CREATE TABLE %dbpre%type (
  tp_num INTEGER PRIMARY KEY,
  tp_desc varchar(30) NOT NULL default '',
  tp_type tinyint(3) NOT NULL default 0,
  tp_team tinyint(1) NOT NULL default 0,
  tp_played mediumint(8) NOT NULL default 0,
  tp_gtime bigint(19) NOT NULL default 0,
  tp_ptime bigint(19) NOT NULL default 0,
  tp_score int(11) NOT NULL default 0,
  tp_kills int(10) NOT NULL default 0,
  tp_deaths int(10) NOT NULL default 0,
  tp_suicides mediumint(8) NOT NULL default 0,
  tp_teamkills mediumint(8) NOT NULL default 0
);
