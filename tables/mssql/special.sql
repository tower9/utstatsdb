...
INSERT INTO %dbpre%special (se_title,se_desc) VALUES('Combo King','15 kills with the Shock Rifle' + char(39) + 's combo');
INSERT INTO %dbpre%special (se_title,se_desc) VALUES('Shaftmaster','15 kills with the Link Gun' + char(39) + 's alt fire');
...
INSERT INTO %dbpre%special (se_title,se_desc) VALUES('Top Gun','Destroying a flying vehicle using a Raptor' + char(39) + 's missiles.');
