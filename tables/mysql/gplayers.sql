CREATE TABLE %dbpre%gplayers (
  ...
  gp_carjack smallint(5) unsigned NOT NULL default 0,
  gp_roadkills smallint(5) unsigned NOT NULL default 0,
  ...
  gp_headhunter tinyint(1) unsigned NOT NULL default 0,
  gp_flakmonkey tinyint(1) unsigned NOT NULL default 0,
  gp_combowhore tinyint(1) unsigned NOT NULL default 0,
  gp_roadrampage tinyint(1) unsigned NOT NULL default 0,
