CREATE TABLE %dbpre%players (
  ...
  plr_headhunter mediumint(8) unsigned NOT NULL default 0,
  plr_flakmonkey mediumint(8) unsigned NOT NULL default 0,
  plr_combowhore mediumint(8) unsigned NOT NULL default 0,
  plr_roadrampage mediumint(8) unsigned NOT NULL default 0,
  plr_carjack mediumint(8) unsigned NOT NULL default 0,
  plr_roadkills mediumint(8) unsigned NOT NULL default 0,
