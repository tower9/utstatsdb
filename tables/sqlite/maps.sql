CREATE TABLE %dbpre%maps (
  ...
  mp_matches mediumint(8) NOT NULL default 0,
  mp_score mediumint(9) NOT NULL default 0,
  mp_kills mediumint(8) NOT NULL default 0,
  mp_deaths mediumint(8) NOT NULL default 0,
  mp_suicides mediumint(8) NOT NULL default 0,
  mp_time bigint(19) NOT NULL default 0,
